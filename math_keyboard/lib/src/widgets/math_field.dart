...
import 'package:math_keyboard_plus/src/foundation/math2tex.dart';
...
import 'package:math_keyboard_plus/src/widgets/math_keyboard.dart';
            ...
            children: [
              Transform.translate(
                ...
                child: Math.tex(
                  tex,
                  options: MathOptions(
                    fontSize: 18, // Reduced from default ~22 to prevent overflow
...
class MathFieldEditingController extends ChangeNotifier {
  ...
  /// Switches between the available keyboard pages.
  void togglePage(int pageCount) {
