...
import 'package:math_keyboard_plus/src/custom_key_icons/custom_key_icons.dart';
import 'package:math_keyboard_plus/src/foundation/keyboard_button.dart';
import 'package:math_keyboard_plus/src/widgets/decimal_separator.dart';
import 'package:math_keyboard_plus/src/widgets/keyboard_button.dart';
import 'package:math_keyboard_plus/src/widgets/math_field.dart';
import 'package:math_keyboard_plus/src/widgets/view_insets.dart';
                              ...
                              Padding(
                                ...
                                child: _Buttons(
                                  ...
                                  page3: type == MathKeyboardType.numberOnly
                                      ? null
                                      : advancedKeyboard,
                                  page4: type == MathKeyboardType.numberOnly
                                      ? null
                                      : statisticsKeyboard,
                                  onSubmit: onSubmit,
                                ),
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: AnimatedBuilder(
        animation: controller,
        builder: (context, child) {
          final pageCount = page4 != null ? 4 : (page3 != null ? 3 : 2);
          final layout = controller.pageIndex == 0
                        ...
                        if (config is BasicKeyboardButtonConfig)
                          ...
                          _BasicButton(
                            ...
                            icon: controller.pageIndex == 0
                                ...
                                : null,
                            label: controller.pageIndex == 0
                                ? null
                                : controller.pageIndex == pageCount - 1
                                    ? '123'
                                    : 'more',
                            onTap: () => controller.togglePage(pageCount),
                            highlightLevel: 1,
                          )
