...
/// Example app demonstrating how to use the `math_keyboard_plus` package.
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: GoogleFonts.notoSansMathTextTheme(),
      ),
...
/// Widget for a page demonstrating how to use the `math_keyboard_plus` package.
